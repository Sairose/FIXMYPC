...
const TNavBar = () => {
  ...
  return (
    <div className='w-full h-[103px] flex justify-between items-center bg-[#2A3794] text-white px-[60px] lg:px-[120px]'>
      ...
      `}>
        <NavLink to={`/technician/dashboard`} onClick={handleLinkClick} className="hover:text-[#05B878] duration-300">Home</NavLink>
        <NavLink to={`/technician/dashboard/booking-requests`} onClick={handleLinkClick} className="hover:text-[#05B878] duration-300">BookRequest</NavLink>
        <NavLink to={`/technician/dashboard/booked`} onClick={handleLinkClick} className="hover:text-[#05B878] duration-300">Booked</NavLink>
        <NavLink to={`/technician/reviews/${user._id}`} onClick={handleLinkClick} className="hover:text-[#05B878] duration-300">Review&Rating</NavLink>
        <NavLink to={`/technician/dashboard/setting`} onClick={handleLinkClick} className="hover:text-[#05B878] duration-300">Profile</NavLink>
